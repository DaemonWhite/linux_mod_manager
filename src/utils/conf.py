...
class ApllicationConfiguration(object):
    ...
    def load_app_settings(self):
        ...
        self._autodetect_games = self.__settings.get_boolean("auto-detect-games")
    ...
    def save_app_settings(self):
        ...
        self.__settings.set_boolean("auto-detect-games",self._autodetect_games)
